    ...
    with st.sidebar:
        ...
        if file:
            ...
            <div class="upload-area">
                <p style="font-size:2rem; margin:0;">FILE</p>
...
def executive_summary_tab(df):
    ...
    with col2:
        ...
        <div class="info-box">
            ...
            <p><strong>Avg Risk Score:</strong> {metrics['avg_risk_score']:.0f}/100</p>
...
def top_performers_tab(df):
    st.markdown("### High Performing Students (90%+)")
...
def ai_recommendation_tab(df):
    ...
    st.markdown("Ask anything about student performance, risks, or recommendations.")

    col1, col2 = st.columns([1, 1])

    with col1:
        st.markdown("#### Student Selector")
        df["display"] = df["student_id"].astype(str) + " - " + df["name"]
        ...
        student_data = df[df["display"] == selected_student].iloc[0]
        ...
        <div class="info-box">
            ...
            <p><strong>Risk Score:</strong> {student_data['Risk_Score']}/100 ({student_data['Risk_Level']})</p>
        </div>
        """, unsafe_allow_html=True)
...
def main():
    ...
    if file:
        ...
        <div style="text-align:center; padding:4rem 2rem; background:#1E1E2E; border-radius:20px;
            ...
            <p style="font-size:4rem; margin:0;">UPLOAD</p>
